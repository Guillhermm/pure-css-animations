# 16-bit Luigi (Pure CSS Pixel Art)

A **pure CSS pixel art recreation of Luigi**, inspired by classic **16-bit era sprites**, built entirely with HTML and CSS, this is, no images, no canvas, no SVG.

This project explores pixel mapping, color layering, and grid-based composition using modern CSS techniques.

![16-bit Luigi Preview](./preview.png)
...
Check out the live animation on [CodePen](https://codepen.io/guillhermm/pen/Byzpqjr).
...
- Sprite state variations (small, big, jumping)
